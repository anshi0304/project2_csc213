...
public class StockQuoteTest {
    ...
    public void testConstructorAndGetters() {
        ...
        assertEquals(110.0, instrument.getHighPrice(), 0.001);
        assertEquals(90.0, instrument.getLowPrice(), 0.001);
        assertEquals(500, instrument.getNumberOfTransactions(), 0.001);
       
        assertEquals(95.0, instrument.getOpenPrice(), 0.001);
        assertEquals(1618320000000L, instrument.getTimestamp(), 0.001);
